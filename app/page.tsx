    ...
    <main className="forge-light overflow-hidden">
      ...
      <section id="diagnostic" className="forge-section border-b forge-border">
        <div className="forge-container">
          <div className="grid gap-10 lg:grid-cols-12"><div className="lg:col-span-4"><p className="forge-eyebrow">Forge diagnostic / 001</p><p className="mt-6 max-w-sm text-sm leading-6 text-[rgba(17,19,17,0.6)]">6 systems · Approximately 10 minutes · Confidential · Immediate result</p></div><div className="lg:col-span-8"><h2 className="forge-heading text-5xl text-[var(--forge-forest-deep)] md:text-7xl">The Sport Department Stress Test</h2><p className="mt-8 max-w-2xl text-xl leading-8 text-[rgba(17,19,17,0.68)]">Assess the six conditions that determine whether your department is resilient or merely coping.</p></div></div>
