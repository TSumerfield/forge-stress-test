...
export const metadata: Metadata = {
  title: "About Forge",
  description: "Forge helps international-school sports leaders see how their departments really work and decide what to strengthen next.",
};
  ...
  return (
    <main className="forge-light overflow-hidden">
        ...
        <div className="forge-container grid min-h-[680px] lg:grid-cols-12">
          <div className="flex flex-col justify-between py-20 lg:col-span-8 lg:border-r lg:pr-16 forge-border xl:py-28">
            <div>
              ...
              <h1 className="forge-display max-w-4xl text-[clamp(4rem,7vw,7.5rem)] text-[var(--forge-forest-deep)]">A clearer view of how school sport really works.</h1>
            </div>
            <p className="mt-16 max-w-3xl border-t pt-8 text-xl leading-9 text-[rgba(17,19,17,0.7)] forge-border md:text-2xl">
              Forge helps international-school sports leaders see what is really happening in their departments, understand the systems and constraints beneath the visible results, and decide what to improve next.
            </p>
          </div>
          <aside className="flex flex-col justify-between py-20 lg:col-span-4 lg:pl-12 xl:py-28 xl:pl-16">
            ...
            <div className="mt-16 border-t pt-6 forge-border"><p className="forge-eyebrow">Independent intelligence</p><p className="mt-3 text-sm leading-6 text-[rgba(17,19,17,0.58)]">Built for international-school sport. Designed to reveal systems, not judge people.</p></div>
          </aside>
        </div>
      </section>
        ...
        <div className="forge-container grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-12 grid gap-8 border-t border-[rgba(185,134,74,0.35)] pt-8 md:grid-cols-2">
              <p className="text-lg leading-8 text-[rgba(246,244,238,0.72)]">School sport departments are often held together by good intentions, individual effort and inherited habits. Delivery continues, so fragility can remain hidden.</p>
      ...
      <section className="forge-section border-b forge-border">
        <div className="forge-container grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-4"><p className="forge-eyebrow">What Forge examines</p><p className="mt-6 max-w-sm text-base leading-7 text-[rgba(17,19,17,0.62)]">Not isolated activities, but the way the parts of a department interact under real-world pressure.</p></div>
          <div className="lg:col-span-8">
            <h2 className="forge-heading max-w-3xl text-5xl text-[var(--forge-forest-deep)] md:text-7xl">The system behind the programme.</h2>
        ...
        <div className="forge-container grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-10 max-w-3xl space-y-6 text-lg leading-8 text-[rgba(17,19,17,0.68)]">
              <p>Forge is being built independently and deliberately. It is not a public ranking, a performance league table or a vehicle for spotlighting individual schools and leaders.</p>
              <p>Diagnostic responses are treated as confidential. Learning shared by Forge will focus on aggregated or anonymised patterns, so the field can gain useful intelligence without identifying participating departments.</p>
              <p>The first tool is the free Sport Department Stress Test: a focused diagnostic across six dimensions, designed to give leaders a clearer departmental profile and one useful next action.</p>
            </div>
          </div>
        </div>
      </section>
