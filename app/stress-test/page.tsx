...
function getProfile(score: number) {
  if (score >= 80) {
    return {
      name: "SYSTEMIC",
      description:
        "Strong systems with relatively low organisational fragility.",
    };
  }
  ...
  return {
    name: "FRAGILE",
    description:
      "Multiple structural weaknesses create material operational risk.",
  };
}

function getFragilitySignals(
          ...
          <div className="mx-auto grid min-h-[78vh] max-w-[1500px] md:grid-cols-12">
            <div className="flex flex-col justify-between border-b border-black/20 px-6 py-12 md:col-span-8 md:border-b-0 md:border-r md:px-10 md:py-16">
              ...
              <div className="mt-16 max-w-2xl">
                <p className="text-xl leading-relaxed md:text-2xl">
                  Strong sport departments are not just busy or successful.
                  They have systems that survive pressure, change and turnover.
                </p>

                <p className="mt-6 text-base leading-relaxed text-black/65 md:text-lg">
                  Forge measures six dimensions of departmental strength to
                  expose hidden fragility, identify your strongest systems and
                  show where improvement will create the most leverage.
                </p>
            ...
            <div className="px-6 py-12 md:col-span-4 md:px-10 md:py-16">
              ...
              <p className="mt-8 text-sm leading-relaxed text-black/55">
                Answer based on how the department actually operates today,
