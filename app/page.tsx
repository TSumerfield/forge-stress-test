...
const dimensions = [
  ["01", "Leadership dependency", "Can the sports operation function without one person holding it together?"],
    ...
    <main className="forge-light overflow-hidden">
      ...
      <section className="relative border-b forge-border">
        <div className="forge-container grid min-h-[calc(100vh-76px)] items-stretch lg:grid-cols-[minmax(0,1fr)_360px] xl:grid-cols-[minmax(0,1fr)_430px]">
          <div className="flex flex-col justify-between py-16 lg:py-20 xl:py-24">
            <div>
              <div className="mb-12 flex items-center gap-4"><span className="forge-rule" /><p className="forge-eyebrow">Independent intelligence for school sports leadership</p></div>
          ...
          <aside className="relative hidden border-l forge-border lg:flex lg:flex-col lg:justify-between lg:py-20 lg:pl-12 xl:py-24 xl:pl-16">
            ...
            <div className="border-t pt-6 forge-border"><p className="forge-eyebrow">Measure · Understand · Improve</p><p className="mt-3 max-w-[280px] text-sm leading-6 text-[rgba(17,19,17,0.58)]">Diagnostics, intelligence and practical systems for stronger sports operations.</p></div>
          </aside>
        </div>
      </section>
      ...
      <section className="forge-dark border-b border-[rgba(185,134,74,0.35)]">
        <div className="forge-container grid gap-12 py-20 lg:grid-cols-12 lg:py-28">
          ...
          <div className="lg:col-span-8">
            <h2 className="forge-heading max-w-4xl text-4xl md:text-6xl">A busy sports operation can look successful while becoming increasingly fragile.</h2>
            <div className="mt-12 grid gap-8 border-t border-[rgba(185,134,74,0.35)] pt-8 md:grid-cols-2"><p className="text-lg leading-8 text-[rgba(246,244,238,0.72)]">Games happen. Teams compete. Events run. Families get informed. Delivery continues.</p><p className="text-lg leading-8 text-[rgba(246,244,238,0.72)]">Yet knowledge stays in people&apos;s heads, leaders become bottlenecks and constant delivery leaves no capacity to improve.</p></div>
          </div>
        </div>
      </section>
      ...
      <section id="diagnostic" className="forge-section border-b forge-border">
        <div className="forge-container">
          ...
          <div className="mt-10 flex flex-col gap-6 md:flex-row md:items-center md:justify-between"><p className="text-sm leading-6 text-[rgba(17,19,17,0.6)]">Receive your operating profile and one high-leverage action.</p><Link href="/stress-test" className="forge-button forge-button-primary w-fit">See where you are exposed</Link></div>
        </div>
      </section>
        ...
        <div className="forge-container">
          ...
          <div className="mt-16 grid border-l border-t forge-border lg:grid-cols-2">
            ...
            <Link href="/systems/dependency-audit" className="group flex min-h-[430px] flex-col justify-between border-b border-r p-8 forge-border transition-colors hover:bg-[var(--forge-forest)] hover:text-[var(--forge-ivory)] lg:p-10">
              <div><div className="flex items-center justify-between"><span className="forge-eyebrow">System 001 / Free protocol</span><span className="h-2 w-2 rotate-45 bg-[var(--forge-bronze)]" /></div><h3 className="forge-heading mt-16 max-w-xl text-4xl md:text-5xl">Dependency Audit.</h3><p className="mt-7 max-w-xl text-base leading-8 text-[rgba(17,19,17,0.62)] group-hover:text-[rgba(246,244,238,0.7)]">A five-day protocol for finding where your operation depends on people when it should depend on systems.</p></div><span className="mt-10 w-fit text-xs font-semibold uppercase tracking-[0.13em] text-[var(--forge-bronze)] underline underline-offset-8">Use the protocol</span>
            </Link>
          </div>
          <div className="mt-8 flex flex-wrap gap-6"><Link href="/insights" className="forge-button text-[var(--forge-forest-deep)]">Explore all insights</Link><Link href="/systems" className="forge-button text-[var(--forge-forest-deep)]">Explore all systems</Link></div>
        </div>
      </section>
