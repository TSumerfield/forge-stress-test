...
export default function ReadinessCheckPage() {
  ...
  if (finished) return (
    <main className="min-h-screen bg-[#f3f0e8] text-black">
      ...
      <section className="border-b border-black/20"><div className="mx-auto grid max-w-[1500px] gap-8 px-6 py-12 md:grid-cols-2 md:px-10 md:py-16"><div><p className="text-xs font-semibold tracking-[0.18em] text-black/55">GO DEEPER</p><h2 className="mt-5 text-4xl font-semibold uppercase tracking-[-0.05em]">Understand the system beneath the gaps.</h2><p className="mt-5 max-w-xl leading-relaxed text-black/60">The Readiness Check shows what needs attention now. The Stress Test examines the structural conditions creating those vulnerabilities.</p><Link href="/stress-test" className="mt-8 inline-block bg-black px-7 py-4 text-xs font-semibold tracking-[0.16em] text-white">TAKE THE STRESS TEST →</Link></div><div className="flex items-end justify-start md:justify-end"><button onClick={restart} className="border border-black px-6 py-4 text-xs font-semibold tracking-[0.14em]">RETAKE THE CHECK</button></div></div></section>
