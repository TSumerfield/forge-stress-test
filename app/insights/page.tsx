...
export const metadata: Metadata = {
  ...
  description: "Forge observations and research on the systems behind sports and athletics operations in international schools.",
};
